...
<div id="alldiv" class="container alldiv" style="text-align: end;margin-top: 2%;">
...
<!-- 	<form method="post"  action=<?php echo base_url('home/update/save'); ?> enctype="multipart/form-data" onsubmit="return validateMyForm();"> -->
        ...
        <div class="title-info">	
    		...
    		<div id="General Information" class="tabcontent">
                ...
                <div class="panel container-fuild">
                	<div class="row required">
                        ...
                        <div class="col-75"><input id="pk_scientist" <?php if($existmodifying == 'inprocess'){ echo 'readonly="readonly"';} ?> type="text" name="pk_scientist" value="<?php echo htmlspecialchars($pk_scientist); ?>" /></div>
                	</div>
                
                	<div class="row required">
                        <div class="col-25"><label>Pharmacometric Scientist (CP&amp;P)</label></div>
                        <div class="col-75"><input id="pm_scientist" type="text" name="pm_scientist" <?php if($existmodifying == 'inprocess'){ echo 'readonly="readonly"';} ?> value="<?php  echo htmlspecialchars($pm_scientist); ?>" /></div>
                	</div>
                	
                	<div class="row required">
                        <div class="col-25"><label>Statistician and/or Programmer (GBS)</label></div>
                        <div class="col-75"><input id="statistician" type="text" name="statistician" <?php if($existmodifying == 'inprocess'){ echo 'readonly="readonly"';} ?> value="<?php  echo htmlspecialchars($statistician); ?>" /></div>
                	</div>
    		    ...
    		    <div class="panel container-fuild">
    				...
    				<div class="row required">
    	                 ...
    	                 <div class="col-75"><input type="text" <?php if($existmodifying == 'inprocess'){ echo 'readonly="readonly"';} ?> id="dataset_name" name="dataset_name" maxlength="8" value="<?php  echo htmlspecialchars($dataset_name); ?>" /></div>
    				</div>
                    ...
                    <div class="row required">
                        ...
                        <div class="col-75"><input type="text" id="dataset_descriptor" name="dataset_descriptor" <?php if($existmodifying == 'inprocess'){ echo 'readonly="readonly"';} ?> value="<?php  echo htmlspecialchars($dataset_description); ?>" /></div>
                    </div>
                    ...
                    <div class="row required">
                         ...
                         <div class="col-75"><input type="text" <?php if($existmodifying == 'inprocess'){ echo 'readonly="readonly"';} ?> id="dataset_criteria" name="dataset_criteria" value="<?php  echo htmlspecialchars($dataset_inclusion); ?>"/></div>
                    </div>
                    
                    <div class="row required">
                    	 <div class="col-25"><label>The dataset will be sorted by: </label></div>
                         <div class="col-75"><input type="text" <?php if($existmodifying == 'inprocess'){ echo 'readonly="readonly"';} ?> id="dataset_sort" name="dataset_sort" value="<?php  echo htmlspecialchars($dataset_sort); ?>" style="text-transform:uppercase"/></div>
                    </div>
                    
                    <div class="row required">
                         <div class="col-25"><label>Dataset Location (final/derived under prd):</label></div>
                         <div class="col-75"><input type="text" <?php if($existmodifying == 'inprocess'){ echo 'readonly="readonly"';} ?> id="dataset_path" name="dataset_path" value="<?php  echo htmlspecialchars($dataset_path); ?>"/></div>
                    </div>

                    <div class="row required">
                         <div class="col-25"><label>Delivery Date:</label></div>
                         <div class="col-75"><input type="date" id="dataset_date" <?php if($existmodifying == 'inprocess'){ echo 'readonly="readonly"';} ?> name="ds_due_date" value="<?php  echo htmlspecialchars($dataset_due_date); ?>"/></div>
                    </div>
					<br/>
                </div>
    		    ...
    		    <div class="panel container-fuild">
					<br/>
    			    <p><b>Program development path: <input name="dataset_dev_path" type="text" <?php if($existmodifying == 'inprocess'){ echo 'readonly="readonly"';} ?> size="80" value="<?php  echo htmlspecialchars($dataset_dev_path);?>"></b></p>
    	            <p><b>Program QC path: <input name="dataset_qc_path" <?php if($existmodifying == 'inprocess'){ echo 'readonly="readonly"';} ?> type="text" size="80" value="<?php  echo htmlspecialchars($dataset_qc_path);?>"></b></p>
    		    </div>	
			...
			<button type="button" style="padding: 11px;" onClick="window.open('<?php echo base_url('home/create/searchvariable'); ?>');" class="w3-btn w3-round-large w3-grey w3-medium">Search Variable</button>
			<br/><br/>
			...
			<?php
				...
				echo '<b>Please select optional variables to add <a style="color:red;">(Note : Click on checkbox to add other optional variable to main table)</a></b>';	
        ...
        $result = array_intersect($otheroptional_value,$dataset_structure_value);
 				...
 				foreach($otheroptional as $arr) {
                    if(!in_array($arr['var_name'], $result)) {
                        ...
                        echo '<td style="width:325px;"><textarea class="struct" ' . $readonlysource1 . ' >'.htmlspecialchars($arr['source']).'</textarea></td>';
     					...
     					// echo '<td style="width:325px;"><textarea class="struct" ' . ($arr['source'] == 0 ? 'readonly':'') . ' >'.htmlspecialchars($arr['source']).'</textarea></td>';
     					// echo '<td>' . $arr['note'] . '</td>';
				...
				echo '</tbody></table> 	';	
				echo '<br/>';
				//echo 'Note : Click on checkbox to add other optional variable to main table';
		...
		<div id="Derivations" class="tabcontent">
	        ...
	        <div class="panel">
				...
				<br/>
				<p><span id="missingtext" name="missingtext"><?php echo htmlspecialchars($missing_outlier['0']['missing']) ?></span></p>
				<br/>
                <?php

                ?>
				<textarea id="missingadd" <?php if($existmodifying == 'inprocess'){ echo 'readonly'; } ?> name="missingadd"><?php echo htmlspecialchars($missing_outlier['0']['missing']) ?> </textarea>
				<br/><br/>
	...
	<br/>
	<center>
		<div id="viewmode"> <b>You are in View Only Mode!</b></div>
	<!-- </form> -->

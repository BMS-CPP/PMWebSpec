...
<div class="Section1">
    ...
    <table border="1">
        <tr  nobr="true">
            ...
            <th style="width: 18%;word-wrap: break-word;">Raw</th>
            <th style="width: 18%;word-wrap: break-word;">SDTM</th>
            <th style="width: 18%;word-wrap: break-word;">ADaM</th>
            <th style="width: 30%;word-wrap: break-word;">Other</th>
        </tr>';
...
';
    ...
    foreach ($data['dataset_structure'] as $arr) {
        ...
        $htmlContent .= '<tr>
            ...
            <td style="font-size:13px;">' . $arr['var_notes'] . '</td>
            <td style="font-size:13px;">' . $arr['var_source'] . '</td>
        </tr>';
    }
    ...
    foreach ($data['flag'] as $arr) {
        ...
        $htmlContent .= '<tr>
            ...
            <td style="font-size:13px;">' . $arr['flag_comment'] . '</td>
            <td style="font-size:13px;">' . $arr['flag_notes'] . '</td>
        </tr>';
    }
